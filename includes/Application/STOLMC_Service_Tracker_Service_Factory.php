 ...
 *
 * @since    1.0.0
 * @package  STOLMC_Service_Tracker\includes\Application
 */
class STOLMC_Service_Tracker_Service_Factory {
	...
	/**
	 * Create an Analytics_Hooks instance.
	 *
	 * @since 1.0.0
	 *
	 * @param Analytics_Logger $logger The Analytics_Logger instance.
	...
	public static function create_analytics_hooks( Analytics_Logger $logger ): Analytics_Hooks {
		...
		if ( $analytics_hooks instanceof Analytics_Hooks ) {
			return $analytics_hooks;
		}

		$analytics_hooks = new Analytics_Hooks( $logger );

		/**
		 * Filters the Analytics_Hooks instance after creation.
		 *
		 * @since 1.0.0
		 *
	...
	/**
	 * Create an Analytics_Hooks instance with its own logger.
	 *
	 ...
	 * @return Analytics_Hooks
	 */
	public static function create_analytics_hooks_with_logger(): Analytics_Hooks {
