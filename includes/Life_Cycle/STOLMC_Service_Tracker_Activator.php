 ...
 *
 * On activation this class delegates table creation to the SchemaManager,
 ...
 * are handled by the SchemaManager on every `init` hook, not here.
 *
 * @since    1.0.0
...
class STOLMC_Service_Tracker_Activator {
	 ...
	 *
	 * Delegates table creation to the SchemaManager and records the
